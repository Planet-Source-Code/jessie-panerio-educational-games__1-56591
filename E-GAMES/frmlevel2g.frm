VERSION 5.00
Begin VB.Form frmlevel2g 
   BackColor       =   &H00000000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Level 2  Guessing Game"
   ClientHeight    =   3195
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4680
...
Private Sub Form_Load()
  ...
  frmguessinggame.txtLevel1VC = 100 - (Val(frmguessinggame.txtWrongAnswer.Text) * 10)
