...
Begin VB.Form frmHighScoreVC 
   ...
   Begin VB.CommandButton cmdPrintRVC 
      BackColor       =   &H00FFFFC0&
      Caption         =   "&Print"
      BeginProperty Font 
         Name            =   "Arial"
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackColor       =   &H00000000&
      Caption         =   "Vowels- Consonant Game Scores"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmHighScoreVC"
...
Private Sub cmdPrintRVC_Click()
With adoresults
Set DataReport2.DataSource = adoresults
DataReport2.Show
End With
End Sub
