...
Begin VB.Form frmlevel2 
   ...
   Caption         =   "Level 2  Vowels-Consonants"
   ClientHeight    =   3195
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4680
...
Private Sub Form_KeyPress(KeyAscii As Integer)
  ...
  If KeyAscii = 13 Then
    ...
    frmVowelsConsonants.txtLevel.Text = "2"
...
Private Sub Form_Load()
  ...
  frmVowelsConsonants.txtLevel1VC = 100 - (Val(frmVowelsConsonants.txtWrongAnswer.Text) * 10)
